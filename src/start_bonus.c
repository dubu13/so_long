...
/*   Updated: 2025/08/31 16:19:12 by dhasan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long_bonus.h"

t_game *game; // Global variable

void	handle_key(mlx_key_data_t keydata, void *param)
{
    game = param; // Remove this line
    // Use global 'game' directly
...
void	ft_init(t_game *g)
{
    ...
    game = g; // Assign the argument to the global variable
