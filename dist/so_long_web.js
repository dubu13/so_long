...
// include: /tmp/tmpq6vwvtb7.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'so_long_web.data';
      var REMOTE_PACKAGE_BASE = 'so_long_web.data';
...
Module['FS_createPath']("/", "texture", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_so_long_web.data');

      }
      Module['addRunDependency']('datafile_so_long_web.data');
    ...
    loadPackage({"files": [{"filename": "/maps/minimal_horizontal.ber", "start": 0, "end": 17}, {"filename": "/maps/minimal_vertical.ber", "start": 17, "end": 36}, {"filename": "/maps/valid1.ber", "start": 36, "end": 105}, {"filename": "/maps/valid2.ber", "start": 105, "end": 314}, {"filename": "/maps/valid3.ber", "start": 314, "end": 566}, {"filename": "/maps/valid4.ber", "start": 566, "end": 1165}, {"filename": "/maps/valid5.ber", "start": 1165, "end": 1918}, {"filename": "/texture/collectible.png", "start": 1918, "end": 3344}, {"filename": "/texture/exit.png", "start": 3344, "end": 11854}, {"filename": "/texture/floor1.png", "start": 11854, "end": 13206}, {"filename": "/texture/player.png", "start": 13206, "end": 14185}, {"filename": "/texture/player_b.png", "start": 14185, "end": 14836}, {"filename": "/texture/player_l.png", "start": 14836, "end": 15843}, {"filename": "/texture/player_r.png", "start": 15843, "end": 16849}, {"filename": "/texture/wall.png", "start": 16849, "end": 21034}], "remote_package_size": 21034});

  })();

// end include: /tmp/tmpq6vwvtb7.js
// include: /tmp/tmpb5cjif2f.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpb5cjif2f.js
// include: /tmp/tmpr3vgte27.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpr3vgte27.js
...
function findWasmBinary() {
    return locateFile('so_long_web.wasm');
}
